...
class TeamTotalsParser:
    ...
    def parse(self, first_team_totals, first_team_advanced_totals, second_team_totals, second_team_advanced_totals):
        return [
            self.parse_totals(
                basic_team_totals=first_team_totals,
                advanced_team_totals=first_team_advanced_totals,
                opposing_team_totals=second_team_totals,
            ),
            self.parse_totals(
                basic_team_totals=second_team_totals,
                advanced_team_totals=second_team_advanced_totals,
                opposing_team_totals=first_team_totals,
            ),
        ]

    def parse_game_log(self, team, basic_team_totals, advanced_team_totals):
        return {
            "team": team,
            "outcome": basic_team_totals.outcome,
            "fg": str_to_int(basic_team_totals.made_field_goals),
            "fga": str_to_int(basic_team_totals.attempted_field_goals),
            "fg_pct": str_to_float(basic_team_totals.field_goals_percentage),
            "fg3": str_to_int(basic_team_totals.made_three_point_field_goals),
            "fg3a": str_to_int(basic_team_totals.attempted_three_point_field_goals),
            "fg3_pct": str_to_float(basic_team_totals.three_point_field_goals_percentage),
            "ft": str_to_int(basic_team_totals.made_free_throws),
            "fta": str_to_int(basic_team_totals.attempted_free_throws),
            "ft_pct": str_to_float(basic_team_totals.free_throws_percentage),
            "orb": str_to_int(basic_team_totals.offensive_rebounds),
            "trb": str_to_int(basic_team_totals.total_rebounds),
            "ast": str_to_int(basic_team_totals.assists),
            "stl": str_to_int(basic_team_totals.steals),
            "blk": str_to_int(basic_team_totals.blocks),
            "to": str_to_int(basic_team_totals.turnovers),
            "pf": str_to_int(basic_team_totals.personal_fouls),
            "pts": str_to_int(basic_team_totals.points),
            "date": basic_team_totals.date,
            "opp": basic_team_totals.opponent,
            "opp_pts": str_to_int(basic_team_totals.opponent_points),
            "opp_fg": str_to_int(basic_team_totals.opponent_field_goals),
            "opp_fga": str_to_int(basic_team_totals.opponent_field_goal_attempts),
            "opp_fg_pct": str_to_float(basic_team_totals.opponent_field_goal_percentage),
            "opp_fg3": str_to_int(basic_team_totals.opponent_three_point_field_goals),
            "opp_fg3a": str_to_int(basic_team_totals.opponent_three_point_field_goal_attempts),
            "opp_ft": str_to_int(basic_team_totals.opponent_free_throws),
            "opp_fta": str_to_int(basic_team_totals.opponent_free_throw_attempts),
            "opp_ft_pct": str_to_float(basic_team_totals.opponent_free_throw_percentage),
            "opp_orb": str_to_int(basic_team_totals.opponent_offensive_rebounds),
            "opp_trb": str_to_int(basic_team_totals.opponent_total_rebounds),
            "opp_ast": str_to_int(basic_team_totals.opponent_assists),
            "opp_stl": str_to_int(basic_team_totals.opponent_steals),
            "opp_blk": str_to_int(basic_team_totals.opponent_blocks),
            "opp_tov": str_to_int(basic_team_totals.opponent_turnovers),
            "opp_pf": str_to_int(basic_team_totals.opponent_personal_fouls),
            "ts_pct": str_to_float(advanced_team_totals.true_shooting_percentage),
            "efg": str_to_float(advanced_team_totals.effective_field_goal_percentage),
            "fg3a_per_fga_pct": str_to_float(advanced_team_totals.attempted_three_point_field_goals_per_field_goal_percent),
            "fta_per_fga_pct": str_to_float(advanced_team_totals.attempted_free_throws_per_field_goal_percent),
            "orb_pct": str_to_float(advanced_team_totals.offensive_rebound_percentage),
            "def_reb_pct": str_to_float(advanced_team_totals.defensive_rebound_percentage),
            "trb_pct": str_to_float(advanced_team_totals.total_rebound_percentage),
            "ast_pct": str_to_float(advanced_team_totals.assist_percentage),
            "stl_pct": str_to_float(advanced_team_totals.steal_percentage),
            "blk_pct": str_to_float(advanced_team_totals.block_percentage),
            "to_pct": str_to_float(advanced_team_totals.turnover_percentage),
            "off_rtg": str_to_float(advanced_team_totals.offensive_rating),
            "def_rtg": str_to_float(advanced_team_totals.defensive_rating),
            "pace": str_to_float(advanced_team_totals.pace),
            "ft_rt": str_to_float(advanced_team_totals.free_throw_rate),
            "opp_efg_pct": str_to_float(advanced_team_totals.opponent_effective_field_goal_rate),
            "opp_tov_pct": str_to_float(advanced_team_totals.opponent_turnover_rate),
            "opp_ft_rate": str_to_float(advanced_team_totals.opponent_free_throw_rate),
        }

    def parse_totals(self, basic_team_totals, advanced_team_totals, opposing_team_totals):
        current_team = self.team_abbreviation_parser.from_abbreviation(basic_team_totals.team_abbreviation)

        if str_to_int(basic_team_totals.points) > str_to_int(opposing_team_totals.points):
            outcome = Outcome.WIN
        elif str_to_int(basic_team_totals.points) < str_to_int(opposing_team_totals.points):
        ...
        return {
            "team": current_team,
            "outcome": outcome,
            "minutes_played": str_to_int(basic_team_totals.minutes_played),
            "made_field_goals": str_to_int(basic_team_totals.made_field_goals),
            "attempted_field_goals": str_to_int(basic_team_totals.attempted_field_goals),
            "field_goals_percentage": str_to_float(basic_team_totals.field_goals_percentage),
            "made_three_point_field_goals": str_to_int(basic_team_totals.made_three_point_field_goals),
            "attempted_three_point_field_goals": str_to_int(basic_team_totals.attempted_three_point_field_goals),
            "three_point_field_goals_percentage": str_to_float(basic_team_totals.three_point_field_goals_percentage),
            "made_free_throws": str_to_int(basic_team_totals.made_free_throws),
            "attempted_free_throws": str_to_int(basic_team_totals.attempted_free_throws),
            "free_throws_percentage": str_to_float(basic_team_totals.free_throws_percentage),
            "offensive_rebounds": str_to_int(basic_team_totals.offensive_rebounds),
            "defensive_rebounds": str_to_int(basic_team_totals.defensive_rebounds),
            "assists": str_to_int(basic_team_totals.assists),
            "steals": str_to_int(basic_team_totals.steals),
            "blocks": str_to_int(basic_team_totals.blocks),
            "turnovers": str_to_int(basic_team_totals.turnovers),
            "personal_fouls": str_to_int(basic_team_totals.personal_fouls),
            "points": str_to_int(basic_team_totals.points),
            "true_shooting_percentage": str_to_float(advanced_team_totals.true_shooting_percentage),
            "effective_field_goal_percentage": str_to_float(advanced_team_totals.effective_field_goal_percentage),
            "attempted_three_point_field_goals_per_field_goal_percent": str_to_float(advanced_team_totals.attempted_three_point_field_goals_per_field_goal_percent),
            "attempted_free_throws_per_field_goal_percent": str_to_float(advanced_team_totals.attempted_free_throws_per_field_goal_percent),
            "offensive_rebound_percentage": str_to_float(advanced_team_totals.offensive_rebound_percentage),
            "defensive_rebound_percentage": str_to_float(advanced_team_totals.defensive_rebound_percentage),
            "total_rebound_percentage": str_to_float(advanced_team_totals.total_rebound_percentage),
            "assist_percentage": str_to_float(advanced_team_totals.assist_percentage),
            "steal_percentage": str_to_float(advanced_team_totals.steal_percentage),
            "block_percentage": str_to_float(advanced_team_totals.block_percentage),
            "turnover_percentage": str_to_float(advanced_team_totals.turnover_percentage),
            "defensive_rating": str_to_float(advanced_team_totals.defensive_rating),
        }
